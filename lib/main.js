...
var _toastGenerator = require('./toast-generator');

var ToastGenerator = _interopRequireWildcard(_toastGenerator);
...
},{"./toast-generator":2}],2:[function(require,module,exports){
'use strict';
...
function generate() {
  ...
  if (randomIntFromInterval(0, 5)) {
    ...
    var red_multiplier = randomIntFromInterval(147, 153) / 100;
    var green_multiplier = randomIntFromInterval(147, 153) / 100;
  ...
  // Nose and mouth
  var blue_coefficient = randomIntFromInterval(20, 70);
  ...
  var face = getTransparentBackground();
  ...
  // Eyes
  var eye_x = randomIntFromInterval(-1, 1);
  var eye_y = randomIntFromInterval(-1, 1);
  ...
  // Nose
  var nose_y = randomIntFromInterval(0, 2);
  face[7 + nose_y][7] = face[7 + nose_y][8] = getAsRGBString(noseColor);
  var abs_nose_y = 7 + nose_y;

  // Mouth
  var mouth_type = randomIntFromInterval(0, 5);
  var mouth_y = undefined,
      mouth_l_x = undefined,
      mouth_length = undefined;
  if (mouth_type < 4) {
    if (randomIntFromInterval(0, 1)) {
